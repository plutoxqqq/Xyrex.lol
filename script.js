const products = [
  ...
  },
  {
    ...
    pros: ['Operating for more than a year', 'Strong execution', 'Decompiler support', 'Kernel-level features', 'RakNet support', 'Lifetime access', 'Recent update brang lots of customisation tools'],
  ...
  },
  {
    ...
    cons: ['None listed'],
    pricingOptions: ['$8.47 monthly', '}9.99 quarterly', '$47.99 yearly'],
    freeOrPaid: 'paid',
    stability: 'Unknown',
    trustLevel: 'Unknown',
    status: 'Unknown',
  ...
  },
  {
    ...
    cons: ['Stability issues', 'Owner recently got comprimised', 'Reports of Velocity containing a RAT'],
    pricingOptions: ['Free'],
    freeOrPaid: 'free',
    stability: 'Mixed',
    trustLevel: 'Low',
  ...
  },
  {
    ...
    pricingOptions: ['$5.99 weekly', '}9.99 monthly'],
    freeOrPaid: 'paid',
    stability: 'Stable',
    trustLevel: 'High',
    status: 'Undetected',
  ...
  },
  {
    ...
    pricingOptions: ['$5.99 weekly', '}9.99 monthly', '$49.99 quarterly'],
    freeOrPaid: 'paid',
    stability: 'Unknown',
    trustLevel: 'Low',
    status: 'Unknown',
  ...
  },
  {
    ...
    pricingOptions: ['$2.49 daily', '$5.99 weekly', '}8.99 monthly', '$39.99 quarterly'],
    freeOrPaid: 'paid',
    stability: 'Stable',
    trustLevel: 'Low',
    status: 'Undetected',
