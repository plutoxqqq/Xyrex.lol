const THEME_KEY = 'xyrex_new_ui_theme';
  ...
  function loadCss() {
    ...
    link.rel = 'stylesheet';
    const mainCss = document.querySelector('link[href*="css/main"]');
    link.href = mainCss
      ? mainCss.getAttribute('href').replace(/main\.css[^'"]*/, 'features/new-ui.css?v=2.1.0')
      : './css/features/new-ui.css?v=2.1.0';
