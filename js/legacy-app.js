...
import { initScripthubPage } from './scripthub/scripthub-page.js';
...
function initScriptsHub() {
  initScripthubPage({
    ...
    estimatedPriceValue,
    scriptsHubData,
    POPULAR_SCRIPT_CATEGORIES,
    popularScriptDiscordSvg,
    popularScriptFileSvg,
    openNoOfficialDiscordModal,


    NO_ASSISTANT_TOKENS_MESSAGE,
    consumeAiTokenForAssistant,
    openNoAiTokensModal,
    setAssistantMessageMarkdown,
    askExploitAssistant,
    getLocalAssistantFallback,
    applyAllFilters,
    syncSubtabButtons,
    setActiveSubtab,
    syncNavButtonsWithPage,
    setActivePage,
    onSavedScriptListClick: event => {
